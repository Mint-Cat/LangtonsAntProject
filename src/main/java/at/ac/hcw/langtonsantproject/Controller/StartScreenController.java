...
/**
 * Controller for the main entry screen.
 * Handles primary navigation and high-level persistence actions.
 */
public class StartScreenController extends SceneControl implements Initializable {
    ...
    /**
     * Initializes the controller and applies the global CSS theme.
     */
    @Override
    ...
    /**
     * Navigates to the settings screen to configure a new ant simulation.
     */
    @FXML
